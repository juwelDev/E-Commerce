    ...
    <div className="-mx-4 flex flex-wrap items-center justify-between">
      ...
      <div className="w-full px-4 lg:w-1/2 xl:w-5/12 ">
        <div className="mt-10 lg:mt-0">
          ...
          <h2 className="mb-5 text-3xl font-bold text-accentOne  sm:text-[40px]/[48px]">
          ...
          <span className="inline-flex items-center justify-center rounded-md border border-transparent bg-primary px-7 py-3 text-center text-base font-medium text-white hover:bg-accentOne"
          >
