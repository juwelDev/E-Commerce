...
const AdminProfileTop: React.FC = () => {
    ...
    return (
        <>
            {user ? (
                <>
                    <div className="flex items-center gap-4" onClick={() => handleOpen(1)}>
                    ...
                    {/* Dropdown Start */}
                    <div className={`${open ? `block` : `hidden`} absolute right-0 mt-4 flex w-62.5 flex-col rounded-sm border border-stroke bg-white shadow-default dark:border-['#2E3A47] dark:bg-[#24303F]`}>
                        <ul className="flex flex-col gap-5 border-b border-stroke px-6 py-7.5 dark:border-[#2E3A47]">
                            <li>
                                <a
                                    href="profile.html"
